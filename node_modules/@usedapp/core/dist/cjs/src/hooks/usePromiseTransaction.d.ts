...
export declare function usePromiseTransaction(chainId: number | undefined, options?: TransactionOptions): {
    promiseTransaction: (transactionPromise: Promise<TransactionResponse>, { safeTransaction }?: PromiseTransactionOpts) => Promise<import("@ethersproject/abstract-provider").TransactionReceipt | undefined>;
