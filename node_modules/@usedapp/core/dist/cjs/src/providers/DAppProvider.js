...
function DAppProviderWithConfig({ children }) {
    ...
    return ((0, jsx_runtime_1.jsx)(context_1.ConnectorContextProvider, { children: (0, jsx_runtime_1.jsx)(window_1.WindowProvider, { children: (0, jsx_runtime_1.jsx)(network_1.ReadonlyNetworksProvider, { children: (0, jsx_runtime_1.jsx)(blockNumbers_1.BlockNumbersProvider, { children: (0, jsx_runtime_1.jsx)(LocalMulticallProvider_1.LocalMulticallProvider, { children: (0, jsx_runtime_1.jsx)(chainState_1.MultiChainStateProvider, { multicallAddresses: multicallAddressesMerged, children: (0, jsx_runtime_1.jsx)(provider_1.NotificationsProvider, { children: (0, jsx_runtime_1.jsx)(provider_2.TransactionProvider, { children: children }) }) }) }) }) }) }) }));
}
